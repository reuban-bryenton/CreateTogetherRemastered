...
This is the unofficial remastered repository and issue-tracker for the modpack Create Together, for Minecraft.
...
2. Open MultiMC.
3. Click Add Instance, choose Minecraft 1.19.2 (the latest version of the pack), click Ok.
...
git fetch                                           # Get changes from git
git checkout dev                                    # Work on the dev channel
git pull                                            # pull changes to check compatability
```
...
2. Fork and clone the repository to the Instances folder of the CurseForge App, the default path is `C:\Users\{UserName}\Documents\Curse\Minecraft\Instances`.
    ...
    - _Note: If you've previously used the CurseForge App the path will most likely be `C:\Users\{UserName}\Documents\curseforge\minecraft\Instances`._
...
-   [CurseForge](https://www.curseforge.com/minecraft/modpacks/createtogether-remastered)
